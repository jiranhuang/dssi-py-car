...
import data_processor_car

logging.basicConfig(level=logging.INFO)

features = ['Age','log_KM','FuelType','HP','CC','Doors','Weight']
numeric_features = ['Age','log_KM','HP','CC','Doors','Weight']
categorical_features = ['FuelType']
label = 'Price'

def run(data_path, model_path, f1_criteria):
    logging.info('Process Data...')
    df = data_processor_car.run(data_path)
